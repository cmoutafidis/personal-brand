...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'projects.fiji.description': 'Advanced data analytics platform built on Snowflake providing comprehensive financial data processing and business intelligence for enterprises.',
    ...
    'industries.data.description': 'Snowflake-powered data engineering and analytics solutions for modern businesses.',

    // Footer
    'footer.description': 'Fiji Solutions is a Snowflake Select Partner and software company in Thessaloniki, Greece, specializing in data engineering, analytics, and custom software development.',
  ...
  el: {
    ...
    'projects.fiji.title': 'Fiji Analytics Dashboard',
    'projects.fiji.description': 'Προηγμένη πλατφόρμα αναλυτικής δεδομένων βασισμένη στη Snowflake που παρέχει ολοκληρωμένη επεξεργασία οικονομικών δεδομένων και business intelligence για επιχειρήσεις.',
    'projects.catalytics.title': 'Catalytics Pro',
    ...
    'services.snowflake.title': 'Snowflake Data Engineering',
    'services.snowflake.description': 'Προηγμένες λύσεις data engineering και analytics με τη Snowflake πλατφόρμα. Ως εταίροι της Snowflake, παρέχουμε ολοκληρωμένες στρατηγικές δεδομένων.',
    ...
    'industries.data.description': 'Λύσεις data engineering και analytics με τη δύναμη της Snowflake για σύγχρονες επιχειρήσεις.',

    // Footer
    'footer.description': 'Η Fiji Solutions είναι Snowflake Select Partner και κορυφαία εταιρεία λογισμικού στη Θεσσαλονίκη, που ειδικεύεται στο data engineering, analytics και εξατομικευμένη ανάπτυξη λογισμικού.',
