...
const aiPrototype: Offer = {
  ...
  copy: {
    ...
    el: {
      metaTitle: 'AI πρωτότυπο, 2 εβδομάδες από τη συνάντηση | Fiji Solutions',
      metaDescription:
      ...
      subhead:
        'Εσύ διαλέγεις την περίπτωση χρήσης. Χτίζουμε ένα AI πρωτότυπο πάνω στα δικά σου δεδομένα και το μετράμε απέναντι σε αυτό που σου κοστίζει σήμερα η ίδια δουλειά. Δύο εβδομάδες από την εναρκτήρια συνάντηση, και τουλάχιστον 75% χαμηλότερο κόστος, αλλιώς σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
          lead: 'Μία περίπτωση χρήσης, όχι πρόγραμμα AI.',
          body: 'Τη διαλέγεις στη συνάντηση. Ανάγνωση εγγράφων προμηθευτών, σύνταξη προσφορών, διαλογή αιτημάτων, ό,τι κοστίζει περισσότερο στο χέρι.'
        },
        {
      ...
      mechanismParagraphs: [
        ...
        'Η μέτρηση τρέχει δίπλα στην υλοποίηση. Καταγράφουμε στη συνάντηση τι κοστίζει σήμερα η περίπτωση χρήσης, και στο τέλος κρίνουμε το πρωτότυπο πάνω στο ίδιο νούμερο.'
      ],
      ...
      stackItems: [
        {
          lead: 'Συνάντηση απαιτήσεων, τέσσερις με έξι ώρες.',
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Η εναρκτήρια συνάντηση. Τέσσερις με έξι ώρες. Γράφουμε τις απαιτήσεις και καταγράφουμε τι κοστίζει σήμερα η περίπτωση χρήσης. Το ρολόι ξεκινά εδώ.'
        },
        {
          when: 'Ημέρες 1 έως 8',
          body: 'Η υλοποίηση. Βλέπεις μια λειτουργική εκδοχή στη μέση της διαδρομής, όχι αποκάλυψη στο τέλος.'
        },
        {
          when: 'Ημέρα 9',
      ...
      timelineNote:
        'Δέκα εργάσιμες ημέρες είναι δύο ημερολογιακές εβδομάδες, μετρημένες από τη συνάντηση. Αν μας λείπουν δεδομένα ή πρόσβαση, το ρολόι σταματά μέχρι να τα λάβουμε.',

      guaranteeTitle: 'Η Εγγύηση Αποδεδειγμένης Εξοικονόμησης',
      guaranteePromise:
        'Το πρωτότυπο έρχεται στην ώρα του, ταιριάζει με τις απαιτήσεις που ενέκρινες, και δείχνει τουλάχιστον 75% μείωση κόστους για τη συμφωνημένη περίπτωση χρήσης, πάνω στη βάση αναφοράς που μετρήσαμε στη συνάντηση. Αν όχι, σου επιστρέφουμε την αμοιβή.',
      guaranteePoints: [
        {
        ...
        },
        {
          ...
          body: 'Στη συνάντηση μετράμε πόσο χρόνο παίρνει σήμερα η περίπτωση χρήσης και τι κοστίζει αυτός ο χρόνος. Το νούμερο μπαίνει στο συμβόλαιο.'
        },
        {
          lead: 'Στην ώρα του, και πάνω στις απαιτήσεις.',
          body: 'Δύο εβδομάδες από τη συνάντηση, απέναντι στις απαιτήσεις που ενέκρινες. Αν περιμένουμε δεδομένα ή πρόσβαση από εσένα, αυτός ο χρόνος δεν μετράει. Αν χάσουμε κάποιο από τα δύο, σου επιστρέφουμε την αμοιβή.'
        },
        {
      ...
      fitNotFor: [
        ...
        'Κανείς δεν μπορεί να διαθέσει τέσσερις με έξι ώρες για τη συνάντηση.',
      ...
      faqs: [
        ...
        {
          q: 'Το πρωτότυπο είναι απλώς μια επίδειξη;',
