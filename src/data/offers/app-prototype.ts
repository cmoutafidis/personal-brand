...
const appPrototype: Offer = {
  ...
  copy: {
    ...
    el: {
      ...
      metaDescription:
        'Χτίζουμε το πρωτότυπο της εφαρμογής σου, δύο εβδομάδες από την εναρκτήρια συνάντηση. Στην ώρα και στις γραπτές προδιαγραφές, αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
      ...
      ogAlt: 'Fiji Solutions - πρωτότυπο εφαρμογής που δουλεύει, δύο εβδομάδες από την εναρκτήρια συνάντηση',

      eyebrow: 'Πρωτότυπο εφαρμογής',
      title: 'Η εφαρμογή σου, να δουλεύει και να πατιέται, δύο εβδομάδες από την εναρκτήρια συνάντηση.',
      subhead:
        'Εσύ φέρνεις την ιδέα. Εμείς κάνουμε μια συνάντηση προδιαγραφών δύο ωρών, χτίζουμε το πρωτότυπο και σου παραδίδουμε την εφαρμογή να δουλεύει, μαζί με τον πηγαίο κώδικα και την τεκμηρίωση. Δύο εβδομάδες από εκείνη τη συνάντηση, πάνω στις προδιαγραφές που ενέκρινες, αλλιώς σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
      ...
      mechanismParagraphs: [
        'Παράγουμε την εφαρμογή αντί να την πληκτρολογούμε. Η συνάντηση βγάζει ένα γραπτό κείμενο προδιαγραφών, και αυτό το κείμενο οδηγεί την παραγωγή του κώδικα. Ό,τι παλιά ήταν εβδομάδες στησίματος παίρνει τώρα ώρες.',
        ...
        'Το AI γράφει τον κώδικα. Εμείς αποφασίζουμε τι πρέπει να κάνει και ελέγχουμε κάθε οθόνη πάνω στο κείμενο που ενέκρινες. Αυτός ο διαχωρισμός είναι ο λόγος που οι δύο εβδομάδες από τη συνάντηση είναι ημερομηνία που μπαίνει στο συμβόλαιο, και ο λόγος που οι προδιαγραφές γράφονται πριν παραχθεί οτιδήποτε.'
      ],
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Η συνάντηση προδιαγραφών. Δύο ώρες. Γράφουμε τι κάνει το πρωτότυπο και το εγκρίνεις. Το ρολόι ξεκινά εδώ.'
        },
        {
          when: 'Ημέρες 1 έως 7',
      ...
      timelineNote:
        'Δέκα εργάσιμες ημέρες είναι δύο ημερολογιακές εβδομάδες, μετρημένες από τη συνάντηση. Αν περιμένουμε μια απόφαση ή μια πρόσβαση που δεν έχουμε ακόμα, το ρολόι σταματά, και σου το λέμε τη μέρα που συμβαίνει.',

      guaranteeTitle: 'Η Εγγύηση Έγκαιρης Παράδοσης Πρωτοτύπου',
      guaranteePromise:
        'Δύο εβδομάδες από τη συνάντηση, πάνω στις προδιαγραφές που ενέκρινες, και τουλάχιστον 75% κάτω από τη βάση συμβατικής κατασκευής που συμφωνήσαμε γραπτά. Αν χάσουμε ένα από τα τρία, σου επιστρέφουμε την αμοιβή σου.',
      guaranteePoints: [
        {
          lead: 'Οι προδιαγραφές γράφονται πριν χτίσουμε.',
          body: 'Η συνάντηση τελειώνει με ένα κείμενο και εσύ το εγκρίνεις. Μετά δεν το μετακινεί κανείς, ούτε εμείς, οπότε το «πάνω στις προδιαγραφές» σημαίνει κάτι που ελέγχεται.'
        },
        {
        ...
        },
        {
          ...
          body: 'Δύο ώρες για τη συνάντηση, έναν άνθρωπο που μπορεί να εγκρίνει τις προδιαγραφές, και απαντήσεις μέσα σε μία εργάσιμη όσο χτίζουμε. Αυτή είναι όλη η λίστα.'
        },
        {
      ...
      fitNotFor: [
        ...
        'Δεν υπάρχει κανείς να παρευρεθεί στη συνάντηση ή στην παράδοση.'
      ],
