...
const aiAgent: Offer = {
  ...
  copy: {
    ...
    el: {
      metaTitle: 'Custom AI agent, εβδομάδα από το workshop | Fiji Solutions',
      metaDescription:
        'Διάλεξε μία διαδικασία. Χτίζουμε AI agent που την τρέχει, μία εβδομάδα από το workshop. Κοστίζει τουλάχιστον 75% λιγότερο, αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
        'custom AI agent, AI agent για επιχειρήσεις, ανάπτυξη AI agent, AI agent για email πελατών, AI agent που τρέχει διαδικασία',
      ogAlt:
        'Fiji Solutions - custom AI agent που τρέχει μία διαδικασία, ζωντανό μία εβδομάδα από το workshop έναρξης',

      eyebrow: 'Custom AI agent για μία διαδικασία',
      title: 'Διάλεξε μία διαδικασία. Μία εβδομάδα από το workshop έναρξης, την τρέχει ένα AI agent.',
      subhead:
        'Εσύ ονομάζεις τη διαδικασία. Εμείς τη χαρτογραφούμε, χτίζουμε το agent και στο παραδίδουμε να δουλεύει. Μία εβδομάδα από το workshop έναρξης, και αυτή η διαδικασία κοστίζει τουλάχιστον 75% λιγότερο από σήμερα, αλλιώς σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
        ...
        {
          lead: 'Μία εβδομάδα από το workshop έναρξης.',
          body: 'Όχι μία εβδομάδα από το πρώτο σου email. Το ρολόι ξεκινά τη μέρα που καθόμαστε μαζί και χαρτογραφούμε τη διαδικασία.'
        },
        {
          lead: 'Η Εγγύηση 75%.',
          body: 'Μετράμε τι σου κοστίζει η διαδικασία σήμερα, στο workshop, γραπτά. Αν το agent δεν το κόψει κατά τουλάχιστον 75%, παίρνεις πίσω την αμοιβή σου.'
        }
      ],
      ...
      mechanismTitle: 'Πώς γίνεται μία εβδομάδα από το workshop έναρξης',
      mechanismParagraphs: [
      ...
      stackItems: [
        {
          lead: 'Workshop χαρτογράφησης, δύο με τρεις ώρες.',
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Το workshop έναρξης. Δύο με τρεις ώρες. Χαρτογραφούμε τη διαδικασία και μετράμε τι σου κοστίζει σήμερα. Το ρολόι ξεκινά εδώ.'
        },
        {
          when: 'Ημέρες 1 έως 3',
      ...
      timelineNote:
        'Πέντε εργάσιμες ημέρες είναι μία ημερολογιακή εβδομάδα, μετρημένες από το workshop. Αν το agent χρειάζεται πρόσβαση που δεν έχουμε ακόμα, το ρολόι σταματά μέχρι να τη λάβουμε, και σου το λέμε τη μέρα που συμβαίνει.',
      ...
      guaranteePoints: [
        {
          ...
          body: 'Το agent είναι ζωντανό μέσα σε μία εβδομάδα από το workshop έναρξης και κάνει αυτό που λένε οι γραπτές προδιαγραφές. Κάθε σφάλμα σε σχέση με αυτές διορθώνεται χωρίς χρέωση. Αν χάσουμε την ημερομηνία, ισχύει η ίδια επιστροφή χρημάτων.'
        },
        {
          lead: 'Η βάση αναφοράς μετριέται πριν χτίσουμε, όχι μετά.',
          body: 'Στο workshop μετράμε τις ώρες που παίρνει η διαδικασία και τα λάθη που παράγει, και γράφουμε το νούμερο. Μπαίνει στο συμβόλαιο, και δεν το μετακινεί μετά καμία πλευρά.'
        },
        {
        ...
        },
        {
          ...
          body: 'Στέλνεις email στο info@fijisolutions.net μέσα σε τριάντα ημέρες από την ημερομηνία μέτρησης που ορίζουμε στο workshop, με τα νούμερα που συμφωνήσαμε. Παίρνεις απάντηση μέσα σε δέκα εργάσιμες ημέρες.'
        }
      ],
      guaranteeClosing:
      ...
      fitNotFor: [
        ...
        'Κανείς εσωτερικά δεν μπορεί να διαθέσει δύο με τρεις ώρες για το workshop.',
