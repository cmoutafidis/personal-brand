...
const aiDevelopmentSprint: Offer = {
  ...
  copy: {
    ...
    el: {
      ...
      metaDescription:
        'Αναπτύσσουμε την επόμενη έκδοση του λογισμικού σου σε 15 ημέρες από το workshop, σύμφωνα με τις γραπτές απαιτήσεις. Αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
        'ανάπτυξη λογισμικού σε 15 ημέρες, κόστος ανάπτυξης λογισμικού, sprint ανάπτυξης λογισμικού, custom software development Ελλάδα, ανάπτυξη λογισμικού με AI',
      ogAlt: 'Fiji Solutions - η επόμενη έκδοση του λογισμικού σου σε sprint 15 ημερών από το workshop έναρξης',

      eyebrow: 'Sprint ανάπτυξης λογισμικού με AI',
      title: 'Η επόμενη έκδοση του λογισμικού σου, έτοιμη 15 ημέρες μετά το workshop έναρξης.',
      subhead:
        'Εσύ φέρνεις την έκδοση που ήδη θέλεις. Εμείς γράφουμε μαζί σου τις απαιτήσεις, χτίζουμε δέκα εργάσιμες, και στην παραδίδουμε να δουλεύει. Δεκαπέντε ημέρες από το workshop, σύμφωνα με το κείμενο που υπέγραψες, αλλιώς σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
          lead: 'Δεκαπέντε ημέρες από το workshop έναρξης.',
        ...
        },
        {
          ...
          body: 'Υπογράφεις ένα κείμενο στο workshop. Ό,τι σου παραδίδουμε ελέγχεται πάνω σε αυτό, σημείο προς σημείο, μπροστά σου.'
        },
        {
          lead: 'Η Εγγύηση Παράδοσης Sprint.',
      ...
      mechanismParagraphs: [
        'Πρώτα γράφουμε τις απαιτήσεις, σε ένα workshop, με τους ανθρώπους που θα χρησιμοποιήσουν στην πράξη το λογισμικό. Αυτό το κείμενο είναι ταυτόχρονα το αντικείμενο, η λίστα δοκιμών και τα κριτήρια αποδοχής. Ο περισσότερος χρόνος σε ένα έργο λογισμικού καίγεται στο να ανακαλύψεις τι ήθελε ο άλλος.',
      ...
      stackItems: [
        {
          lead: 'Workshop απαιτήσεων, τέσσερις έως οκτώ ώρες.',
        ...
        {
          lead: 'Sprint υλοποίησης δέκα ημερών.',
        ...
        },
        {
          ...
          body: 'Τι θα έχτιζε το επόμενο sprint, από τι εξαρτάται, και τι μπορεί να κάνει η δική σου ομάδα χωρίς εμάς. Πήγαινε αυτή τη λίστα όπου θέλεις.'
        },
        {
          lead: 'Αμοιβή κλειδωμένη πριν ξεκινήσει το sprint.',
          body: 'Συμφωνείται γραπτά στο workshop, πάνω στο αντικείμενο του κειμένου. Δεν μετακινείται επειδή η υλοποίηση βγήκε πιο δύσκολη.'
        }
      ],
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Το workshop έναρξης. Τέσσερις έως οκτώ ώρες. Γράφουμε τις απαιτήσεις, συμφωνούμε το αντικείμενο, και καταγράφουμε τη βάση αναφοράς πάνω στην οποία μετριέται η εγγύηση. Το ρολόι ξεκινά εδώ.'
        },
        {
      ...
      timelineNote:
        'Έντεκα εργάσιμες μετά από ένα workshop της Δευτέρας πέφτουν στη δέκατη πέμπτη ημερολογιακή ημέρα. Από εκεί βγαίνει το δεκαπέντε, και μετριέται από το workshop. Αν περιμένουμε πρόσβαση που δεν έχουμε ακόμα, το ρολόι σταματά, και σου το λέμε τη μέρα που συμβαίνει.',

      guaranteeTitle: 'Η Εγγύηση Παράδοσης Sprint',
      guaranteePromise:
        'Παραδίδουμε τη δέκατη πέμπτη ημέρα από το workshop έναρξης, σύμφωνα με τις απαιτήσεις που υπέγραψες, με τα σφάλματα να διορθώνονται χωρίς χρέωση, και με κόστος ανάπτυξης τουλάχιστον 75% κάτω από τη γραπτά συμφωνημένη βάση για το ίδιο αντικείμενο. Αν χάσουμε ένα από τα τέσσερα, σου επιστρέφουμε την αμοιβή.',
      guaranteePoints: [
        {
          lead: 'Στην ώρα της, μετρημένη από το workshop.',
        ...
        },
        {
          ...
          body: 'Το κείμενο του workshop είναι το τεστ. Το περνάμε μαζί σου την ημέρα της παρουσίασης, σημείο προς σημείο. Ό,τι λείπει, λείπει.'
        },
        {
        ...
        },
        {
          ...
          body: 'Στο workshop κοστολογούμε το ίδιο αντικείμενο με τον συμβατικό τρόπο, σε ανθρωποημέρες, με τη χρέωση που μας δίνεις. Αυτό το νούμερο μπαίνει στο συμβόλαιο, και το 75% μετριέται πάνω σε αυτό. Δεν το μετακινεί κανείς μας μετά.'
        },
        {
      ...
      guaranteeClosing:
        'Αυτοί οι όροι μπαίνουν στο συμβόλαιο πριν χτίσουμε, με αυτά ακριβώς τα λόγια. Το 75% είναι υπόσχεση με επιστροφή χρημάτων από πίσω, μετρημένη πάνω σε ένα νούμερο που συμφωνούμε και οι δύο πριν ξεκινήσει το sprint. Δεν είναι αναφορά για το τι πέτυχαν προηγούμενοι πελάτες.',
      ...
      fitFor: [
        ...
        'Μπορείς να διαθέσεις τέσσερις έως οκτώ ώρες στο workshop, με τους ανθρώπους που θα χρησιμοποιήσουν το λογισμικό.',
      ...
      fitNotFor: [
        ...
        'Οι απαιτήσεις είναι ακόμα διαφωνία ανάμεσα σε δύο ανθρώπους. Λύσε την πρώτα, και μετά κλείσε το workshop.',
        'Κανείς εσωτερικά δεν μπορεί να διαθέσει τέσσερις έως οκτώ ώρες την ημέρα μηδέν.',
        'Θέλεις το sprint χωρίς τη βάση αναφοράς. Η εγγύηση στηρίζεται στη βάση αναφοράς.'
      ],
      ...
      faqs: [
        {
          q: 'Πόσο κοστίζει;',
          a: 'Σου δίνουμε προσφορά μετά την πρώτη κλήση, γραπτά, πάνω στο αντικείμενο που συμφωνούμε στο workshop. Δεν υπάρχει τιμοκατάλογος, γιατί το να κοστολογήσεις μια έκδοση χωρίς να τη δεις είναι μαντεψιά. Η αμοιβή κλειδώνει πριν ξεκινήσει το sprint και δεν μετακινείται μετά.'
        },
        {
          q: 'Δεκαπέντε ημέρες από πότε;',
          a: 'Από το workshop έναρξης, ποτέ από το πρώτο σου email. Ανάμεσα στο πρώτο σου μήνυμα και σε εκείνο το workshop υπάρχει μια κλήση και ένας γύρος αποσαφήνισης. Το πόσο κρατάνε εξαρτάται κυρίως από το πόσο γρήγορα καθαρίζουν οι απαιτήσεις σου.'
        },
        {
          q: 'Ποιος έχει τον κώδικα;',
          a: 'Εσύ. Γράφεται απευθείας στο δικό σου repository, οπότε ο κώδικας είναι δικός σου από το πρώτο commit. Το αντικείμενο που υπογράφεις στο workshop το λέει ρητά.'
        },
        {
        ...
        },
        {
          ...
          a: 'Αποφασίζεις εσύ. Δύο δρόμοι είναι ανοιχτοί: ένα ακόμα sprint μαζί μας, ή τα γραπτά επόμενα βήματα πάνε στους δικούς σου προγραμματιστές. Είναι γραμμένα ώστε να δουλεύουν και στις δύο περιπτώσεις, και δεν είσαι υποχρεωμένος να συνεχίσεις μαζί μας.'
        }
      ],

      ctaButton: 'Θέλω το sprint για την έκδοσή μου',
      ctaCallout:
      ...
      formSubhead:
        'Περίγραψε την έκδοση που θέλεις να βγει. Επιστρέφουμε με το τι θα χρειαζόταν για να χτιστεί σε ένα sprint.',
