...
const softwarePrototype: Offer = {
  ...
  copy: {
    ...
    el: {
      ...
      metaDescription:
        'Πρωτότυπο λογισμικού που δουλεύει, δύο εβδομάδες από το workshop έναρξης. Στην ώρα του, στις γραπτές προδιαγραφές, αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
      ...
      ogAlt: 'Fiji Solutions - πρωτότυπο λογισμικού σε δύο εβδομάδες από το workshop έναρξης',

      eyebrow: 'Πρωτότυπο λογισμικού',
      title: 'Δείξε τους το λογισμικό, αντί για τις διαφάνειες. Δύο εβδομάδες από το workshop έναρξης.',
      subhead:
        'Εσύ φέρνεις την ιδέα και τους ανθρώπους που θα τη χρησιμοποιήσουν. Εμείς τη μετατρέπουμε σε λογισμικό που τρέχει, με τον πηγαίο κώδικα και την τεκμηρίωση στα χέρια σου. Δύο εβδομάδες από το workshop έναρξης, στην ώρα του και πάνω σε αυτά που γράψαμε, αλλιώς σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Το workshop έναρξης. Δύο ώρες. Γράφουμε μαζί τις προδιαγραφές και συμφωνούμε τι πρέπει να κάνει το πρωτότυπο. Το ρολόι ξεκινά εδώ.'
        },
        {
          when: 'Ημέρες 1 έως 7',
      ...
      timelineNote:
        'Δέκα εργάσιμες ημέρες είναι δύο ημερολογιακές εβδομάδες, μετρημένες από το workshop. Αν το πρωτότυπο χρειάζεται πρόσβαση σε σύστημα που δεν έχουμε ακόμα, το ρολόι σταματά μέχρι να τη λάβουμε, και σου το λέμε τη μέρα που συμβαίνει.',
      ...
      guaranteePoints: [
        ...
        },
        {
          ...
          body: 'Στο workshop γράφουμε τι θα κόστιζε το ίδιο αντικείμενο εργασίας με συμβατική ανάπτυξη, με βάση την προσφορά που ήδη έχεις ή το ημερήσιο κόστος της ομάδας σου. Αυτό το νούμερο μπαίνει στο συμβόλαιο και δεν το μετακινεί μετά καμία πλευρά.'
        },
        {
          lead: 'Στην ώρα του σημαίνει την ημερομηνία του συμβολαίου.',
          body: 'Δύο εβδομάδες από το workshop, μετρημένες σε εργάσιμες ημέρες, με τον κανόνα παύσης γραμμένο μέσα στον ίδιο όρο.'
        },
        {
      ...
      fitNotFor: [
        ...
        'Κανείς εσωτερικά δεν μπορεί να διαθέσει δύο ώρες για το workshop.',
        'Θέλεις να προσπεράσουμε το workshop και να χτίσουμε από ένα σύντομο brief. Η εγγύηση στηρίζεται σε αυτό το κείμενο.'
      ],
