...
const websiteSeo: Offer = {
  ...
  copy: {
    ...
    el: {
      metaTitle: 'Ιστοσελίδα και SEO | Fiji Solutions',
      metaDescription:
        'Ιστοσελίδα και SEO, τρεις εβδομάδες από το workshop έναρξης. Συμφωνούμε γραπτά στόχο για νέα αιτήματα από την αναζήτηση, αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
        'κατασκευή ιστοσελίδας, SEO Ελλάδα, βελτιστοποίηση ιστοσελίδας, περισσότεροι πελάτες από Google, Google Business Profile, ανακατασκευή ιστοσελίδας',
      ogAlt: 'Fiji Solutions - ιστοσελίδα και SEO, τρεις εβδομάδες από το workshop έναρξης',

      eyebrow: 'Ιστοσελίδα και SEO για περισσότερους πελάτες',
      title: 'Μια ιστοσελίδα που σου φέρνει πελάτες από την αναζήτηση. Ζωντανή τρεις εβδομάδες από το workshop έναρξης.',
      subhead:
        'Ξαναχτίζουμε ή βελτιστοποιούμε το site, κάνουμε τη δουλειά του SEO και τακτοποιούμε το Google Business Profile. Τον στόχο για νέα αιτήματα τον συμφωνούμε γραπτά πριν ξεκινήσουμε, και αν το site τον χάσει, σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
          lead: 'Ένα site, ένας στόχος, συμφωνημένος γραπτά.',
        ...
        },
        {
          ...
          body: 'Το ρολόι ξεκινά τη μέρα που καθόμαστε μαζί και συμφωνούμε τι πρέπει να κάνει το site. Ό,τι γίνεται πριν από εκείνη τη μέρα είναι προετοιμασία.'
        },
        {
          lead: 'Η Εγγύηση Συμφωνημένου Στόχου.',
          body: 'Αν το site χάσει τον στόχο που συμφωνήσαμε, παίρνεις πίσω την αμοιβή σου. Ο αριθμός και η ημερομηνία μπαίνουν στο συμβόλαιο πριν χτίσουμε.'
        }
      ],

      problemTitle: 'Το site που δείχνει μια χαρά και δεν πουλάει τίποτα',
      problemParagraphs: [
        ...
        'Έτσι σε βρίσκουν όπως πάντα. Από στόμα σε στόμα, με καμιά σύσταση, και με ό,τι πληρώνεις. Στο μεταξύ κάποιος στην αγορά σου γράφει στο Google αυτό ακριβώς που πουλάς, και του βγαίνουν τρεις ανταγωνιστές και ένας κατάλογος.',
      ...
      mechanismParagraphs: [
        'Ξεκινάμε από αυτά που γράφουν οι άνθρωποι όταν είναι έτοιμοι να αγοράσουν αυτό που πουλάς. Αυτή η λίστα αποφασίζει ποιες σελίδες χρειάζεται το site και τι λένε.',
        'Μετά χτίζουμε. Το site τρέχει πάνω σε βάση που αναλαμβάνει μόνη της τη δομή, την ταχύτητα και το τεχνικό SEO, οπότε εκεί δεν ξοδεύονται οι τρεις εβδομάδες. Το AI γράφει τα προσχέδια και ελέγχει κάθε σελίδα απέναντι στο brief. Κάθε γραμμή περνά από εμάς πριν βγει.',
        'Γι᾽ αυτό η εκτίμηση είναι τρεις εβδομάδες. Το αργό κομμάτι μιας ιστοσελίδας είναι να αποφασιστεί τι λέει. Αυτό γίνεται στο workshop, την ημέρα μηδέν, με εσένα στο τραπέζι.'
      ],
      ...
      stackItems: [
        {
          ...
          body: 'Τι πρέπει να κάνει το site, σε ποιον απευθύνεται, ποιες αναζητήσεις αξίζει να κερδίσεις. Φεύγουμε με τον στόχο και τη βάση αναφοράς γραμμένα.'
        },
        {
          lead: 'Η υλοποίηση.',
          body: 'Το site ξαναχτισμένο ή βελτιστοποιημένο, σελίδα σελίδα, πάνω στο brief του workshop. Γραμμένο για τον άνθρωπο που ψάχνει, δομημένο για τη μηχανή που διαβάζει.'
        },
        {
          lead: 'Η ιστοσελίδα σου, φιλοξενημένη και ζωντανή.',
        ...
        },
        {
          ...
          body: 'Καταχωρίσεις, προφίλ και σελίδες συνεργατών, αληθινά και σχετικά με τη δουλειά σου. Δεν αγοράζουμε συνδέσμους από δίκτυα. Το Google το καταλαβαίνει και την ποινή τη σηκώνεις εσύ.'
        },
        {
          lead: 'Παρουσίαση και παράδοση, δύο με τέσσερις ώρες.',
          body: 'Περνάμε το site μαζί, σου δείχνουμε τι αλλάζεις μόνος σου, και παραδίδουμε τη γραπτή τεκμηρίωση.'
        },
        {
          lead: 'Go-live, δύο με τέσσερις ώρες.',
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Το workshop έναρξης. Τέσσερις με έξι ώρες. Συμφωνούμε τι πρέπει να κάνει το site, διαλέγουμε τις αναζητήσεις, και μετράμε τι σου φέρνει σήμερα η αναζήτηση. Το ρολόι ξεκινά εδώ.'
        },
        {
        ...
        {
          when: 'Ημέρα 15',
          body: 'Go-live. Ανακατευθύνσεις, analytics, Search Console, και η πρώτη μέτρηση.'
        }
      ],
      timelineNote:
        'Δεκαπέντε εργάσιμες ημέρες είναι τρεις ημερολογιακές εβδομάδες, μετρημένες από το workshop. Η αναζήτηση απαντά με τον δικό της ρυθμό, οπότε ο στόχος για τα αιτήματα έχει δικό του παράθυρο, συμφωνημένο στο ίδιο κείμενο. Αν περιμένουμε περιεχόμενο ή πρόσβαση στο domain, το ρολόι σταματά και σου το λέμε τη μέρα που συμβαίνει.',

      guaranteeTitle: 'Η Εγγύηση Συμφωνημένου Στόχου',
      guaranteePromise:
        'Συμφωνούμε γραπτά, πριν χτίσουμε, στόχο για νέα αιτήματα και το διάστημα στο οποίο μετριέται. Αν το site τον χάσει, σου επιστρέφουμε την αμοιβή σου.',
      guaranteePoints: [
        {
          lead: 'Η βάση αναφοράς μετριέται στο workshop, πριν χτίσουμε.',
          body: 'Στο workshop μετράμε πόσα αιτήματα σου φέρνει σήμερα η αναζήτηση, από τα analytics σου και από το inbox σου. Το νούμερο μπαίνει στο συμβόλαιο και δεν το μετακινεί μετά καμιά πλευρά.'
        },
        {
          lead: 'Ο στόχος είναι ένα νούμερο και μια ημερομηνία.',
          body: 'Πόσα αιτήματα από την αναζήτηση, σε πόσο διάστημα από το go-live. Και τα δύο συμφωνούνται μαζί σου και γράφονται πριν χτιστεί οτιδήποτε.'
        },
        {
          lead: 'Στην ώρα του, και σύμφωνο με ό,τι συμφωνήσαμε.',
          body: 'Το site βγαίνει live τη συμφωνημένη μέρα και κάνει αυτά που λένε οι γραπτές απαιτήσεις. Κάθε σφάλμα απέναντί τους το διορθώνουμε χωρίς χρέωση. Αν χάσουμε τη συμφωνημένη μέρα, ισχύει η ίδια επιστροφή χρημάτων. Τη ζητάς με τον ίδιο τρόπο, μέσα σε τριάντα ημέρες από εκείνη τη μέρα.'
        },
        {
          lead: 'Δεν υποσχόμαστε θέση στα αποτελέσματα.',
          body: 'Κανείς δεν μπορεί. Το Google δεν πουλάει θέσεις. Στο συμβόλαιο μπαίνει ο αριθμός των αιτημάτων, γιατί αυτό είναι που ήθελες στην πραγματικότητα.'
        },
        {
          lead: 'Τι ζητάμε από εσένα.',
          body: 'Να μένει το site ζωντανό, να απαντάς σε ερωτήσεις μέσα σε λίγες μέρες, και να μας αφήνεις να βλέπουμε τα analytics. Αυτή είναι όλη η λίστα.'
        },
        {
      ...
      fitFor: [
        ...
        'Μπορείς να διαθέσεις τέσσερις με έξι ώρες για το workshop και να απαντάς σε ερωτήσεις όσο χτίζουμε.',
      ...
      fitNotFor: [
        ...
        'Κανείς εσωτερικά δεν μπορεί να πει τι πουλάει η επιχείρηση και σε ποιον. Το workshop χρειάζεται απάντηση.',
        'Θέλεις το site ζωντανό την άλλη εβδομάδα. Τρεις εβδομάδες από το workshop είναι η πιο σύντομη ειλικρινής απάντηση.',
      ...
      faqs: [
        {
          q: 'Πόσο κοστίζει;',
          a: 'Σου δίνουμε προσφορά μετά την πρώτη κλήση, γραπτά, με βάση αυτό που χρειάζεται πραγματικά το site σου. Δεν υπάρχει τιμοκατάλογος, γιατί το να κοστολογήσεις μια ιστοσελίδα χωρίς να τη δεις είναι μαντεψιά. Η αμοιβή κλειδώνει πριν χτιστεί οτιδήποτε και δεν μετακινείται μετά.'
        },
        {
          q: 'Μας εγγυάστε πρώτη θέση στο Google;',
          a: 'Όχι. Θέση στο Google δεν πουλάει κανείς, ούτε εμείς. Στο συμβόλαιό σου μπαίνει ο αριθμός των αιτημάτων από την αναζήτηση, η ημερομηνία που μετριούνται, και η επιστροφή χρημάτων αν το site τα χάσει.'
        },
        {
          q: 'Πόσο θέλει το SEO για να πιάσει;',
          a: 'Το site βγαίνει live δεκαπέντε εργάσιμες ημέρες από το workshop. Η αναζήτηση θέλει περισσότερο για να απαντήσει. Γι᾽ αυτό ο στόχος έχει δίπλα του γραπτό διάστημα, συμφωνημένο μαζί σου πριν ξεκινήσουμε. Όποιος σου υπόσχεται αποτελέσματα την πρώτη εβδομάδα πουλάει διαφήμιση και τη λέει SEO.'
        },
        {
          q: 'Θα μας βρίσκει το ChatGPT και οι άλλες AI απαντήσεις;',
          a: 'Βοηθά η ίδια δουλειά: καθαρές σελίδες, πραγματικές απαντήσεις στις ερωτήσεις που κάνει ο κόσμος, προφίλ επιχείρησης που ταιριάζει, και site που διαβάζεται από μηχανή. Το χτίζουμε συνειδητά για αυτό. Δεν το εγγυόμαστε, γιατί κανείς δεν ελέγχει τι θα πει ένα μοντέλο.'
        },
        {
      ...
      ctaCallout:
        'Δωρεάν κλήση, χωρίς δέσμευση. Φεύγεις ξέροντας ποιες αναζητήσεις χρησιμοποιούν στ᾽ αλήθεια οι πελάτες σου και τι θα χρειαζόταν το site σου για να τις κερδίσει, είτε μας αναθέσεις τη δουλειά είτε όχι.',
      ...
      formMessageLabel: 'Η διεύθυνση του site σου, και τι θέλεις να σου φέρνει (προαιρετικό)',
      formMessagePlaceholder: 'π.χ. ietairia.gr, θέλουμε αιτήματα από την αναζήτηση…',
