  ...
  copy: {
    en: {
      ...
      faqs: [
        {
          q: 'What does it cost?',
          a: 'We quote it after the first call, in writing, against what your site and your market need. There is no list price, because scoping a website without seeing yours is guessing. The fee is fixed before anything is built. Your click budget is separate, and you pay Google directly.'
        },
        {
    ...
    el: {
      metaTitle: 'Ιστοσελίδα + Google Ads | Fiji Solutions',
      metaDescription:
        'Φτιάχνουμε το site σου και ξεκινάμε καμπάνια Google Ads τρεις εβδομάδες μετά το workshop. Συμφωνούμε γραπτά στόχο leads, αλλιώς επιστρέφουμε την αμοιβή.',
      metaKeywords:
        'διαφήμιση στη Google, Google Ads διαχείριση, κατασκευή ιστοσελίδας και Google Ads, καμπάνια Google Ads, διαφημίσεις Google για μικρή επιχείρηση',
      ogAlt: 'Fiji Solutions - ιστοσελίδα και καμπάνια Google Ads στον αέρα τρεις εβδομάδες μετά το workshop έναρξης',

      eyebrow: 'Ιστοσελίδα και καμπάνια Google Ads',
      title: 'Το site σου και η καμπάνια σου στο Google Ads, στον αέρα τρεις εβδομάδες μετά το workshop έναρξης.',
      subhead:
        'Ξαναχτίζουμε ή βελτιώνουμε το site σου, το φιλοξενούμε και ανεβάζουμε την καμπάνια μέσα στον δικό σου λογαριασμό Google Ads. Πριν χτιστεί οτιδήποτε, συμφωνούμε γραπτά πόσα leads πρέπει να σου φέρει. Αν δεν τα φέρει, σου επιστρέφουμε την αμοιβή.',
      bullets: [
        {
          lead: 'Το site και οι διαφημίσεις είναι μία δουλειά.',
        ...
        {
          lead: 'Τρεις εβδομάδες από το workshop έναρξης.',
        ...
        },
        {
          ...
          body: 'Ο στόχος σε leads μπαίνει στο συμβόλαιο πριν χτιστεί οτιδήποτε. Αν η καμπάνια δεν τον πιάσει μέσα στο συμφωνημένο διάστημα, παίρνεις πίσω την αμοιβή σου.'
        }
      ],

      problemTitle: 'Το site που δεν φέρνει ποτέ κανέναν',
      problemParagraphs: [
        'Το site σου είναι online εδώ και χρόνια. Δείχνει μια χαρά. Λέει τι κάνεις. Και τα τηλέφωνα χτυπάνε πάλι από ανθρώπους που ήδη σε ήξεραν, όπως ακριβώς και πριν υπάρξει.',
        ...
        'Έτσι το site κάθεται, οι διαφημίσεις είναι κλειστές, και η διόρθωση μένει σε μια λίστα που μεταφέρεται από μήνα σε μήνα. Στο μεταξύ, όσοι ψάχνουν σήμερα αυτό που πουλάς κάνουν κλικ σε κάποιον άλλον.'
      ],

      mechanismTitle: 'Γιατί φτάνουν τρεις εβδομάδες',
      mechanismParagraphs: [
        'Το λέμε χτίσιμο με πρώτη την αναζήτηση. Ξεκινάμε από αυτό που πληκτρολογεί στα αλήθεια ο κόσμος στη Google όταν θέλει αυτό που πουλάς, και αυτή η μία λίστα οδηγεί και τα δύο κομμάτια της δουλειάς. Οι σελίδες απαντούν σε αυτές τις αναζητήσεις. Οι διαφημίσεις δίνουν προσφορά σε αυτές. Η φράση αναζήτησης, η διαφήμιση και η σελίδα λένε το ίδιο πράγμα.',
        'Το χτίσιμο είναι γρήγορο γιατί δεν σχεδιάζουμε site από λευκή σελίδα. Το συναρμολογούμε από μια βιβλιοθήκη κομματιών που συντηρούμε εμείς, και το AI κάνει το πρώτο πέρασμα στη δομή και στα κείμενα. Κάθε γραμμή περνά από εμάς πριν βγει.',
        'Η μέτρηση στήνεται πριν την εκκίνηση. Φόρμες, κλήσεις και μετατροπές καταγράφονται από το πρώτο κιόλας κλικ, μέσα σε λογαριασμούς που είναι δικοί σου. Αυτό είναι που κάνει τον στόχο της εγγύησης ελέγξιμο και από τους δύο.'
      ],
      ...
      stackItems: [
        {
          ...
          body: 'Σε ποιον πουλάς, τι αξίζει ένας πελάτης για εσένα, η λίστα με τις λέξεις-κλειδιά, και ο στόχος σε leads που μπαίνει στο συμβόλαιο.'
        },
        {
          lead: 'Η υλοποίηση.',
          body: 'Το site σου, ξαναχτισμένο ή βελτιωμένο, με κάθε σελίδα γραμμένη πάνω σε μια αναζήτηση που κάποιος κάνει στα αλήθεια.'
        },
        {
          lead: 'Συνάντηση παρουσίασης, δύο με τέσσερις ώρες.',
          body: 'Σου δείχνουμε site και καμπάνια πριν βγει οτιδήποτε δημόσια, και μας λες τι αλλάζει.'
        },
        {
          lead: 'Εκκίνηση, δύο με τέσσερις ώρες.',
        ...
        },
        {
          ...
          body: 'Το site τρέχει στη δική μας φιλοξενία. Αν κάποτε το θέλεις αλλού, σου παραδίδουμε τα αρχεία και τις προσβάσεις.'
        },
        {
      ...
      timeline: [
        {
          when: 'Ημέρα 0',
          body: 'Το workshop έναρξης. Τέσσερις με έξι ώρες. Αντικείμενο, λέξεις-κλειδιά, τι μετράει ως lead, και ο στόχος. Το ρολόι ξεκινά εδώ.'
        },
        {
        ...
        {
          when: 'Ημέρα 15',
          body: 'Εκκίνηση, δύο με τέσσερις ώρες. Το domain αλλάζει, η καμπάνια ανοίγει, και βλέπουμε μαζί την πρώτη επισκεψιμότητα.'
        }
      ],
      timelineNote:
        'Δεκαπέντε εργάσιμες ημέρες είναι τρεις ημερολογιακές εβδομάδες, μετρημένες από το workshop. Αν περιμένουμε το domain σου, τον λογαριασμό διαφημίσεων ή το υλικό σου, το ρολόι σταματά μέχρι να τα λάβουμε, και σου το λέμε τη μέρα που συμβαίνει.',

      guaranteeTitle: 'Η Εγγύηση Συμφωνημένου Στόχου',
      guaranteePromise:
        'Συμφωνούμε γραπτά έναν στόχο σε leads πριν χτίσουμε. Αν η καμπάνια δεν τον πιάσει μέσα στο συμφωνημένο διάστημα, σου επιστρέφουμε την αμοιβή.',
      guaranteePoints: [
        {
          lead: 'Ο στόχος γράφεται πριν χτίσουμε, όχι μετά.',
          body: 'Πόσα leads, σε πόσο διάστημα, και τι μετράει ως lead. Και τα τρία μπαίνουν στο συμβόλαιο μέσα στο workshop και δεν τα μετακινεί μετά κανένας μας. Αν θέλεις και ανώτατο κόστος ανά lead, μπαίνει και αυτό.'
        },
        {
          lead: 'Το lead ορίζεται μία φορά και μετριέται το ίδιο σε όλη τη διαδρομή.',
        ...
        },
        {
          ...
          body: 'Τρεις εβδομάδες από το workshop, και η ημερομηνία μπαίνει στο συμβόλαιο. Αν αργήσουμε με δική μας ευθύνη, μπορείς να ακυρώσεις και σου επιστρέφουμε την αμοιβή. Αν κάτι από όσα παραδίδουμε δεν ταιριάζει με το έγγραφο απαιτήσεων που υπογράψαμε, το διορθώνουμε χωρίς χρέωση.'
        },
        {
          lead: 'Τι ζητάμε από εσένα.',
          body: 'Να κρατήσεις τον προϋπολογισμό των κλικ ανοιχτό για όλο το διάστημα, να μας δώσεις πρόσβαση στο domain και στους λογαριασμούς, και να απαντάς σε κάθε lead μέσα σε μία εργάσιμη ημέρα. Ένα lead που δεν το πήρε κανείς τηλέφωνο δεν είναι αποτυχία της καμπάνιας.'
        },
        {
      ...
      fitFor: [
        ...
        'Πουλάς κάτι που ο κόσμος το ψάχνει. Αν δεν είσαι σίγουρος, το ελέγχουμε στο workshop.'
      ],
      fitNotForLabel: 'Δεν είναι για εσένα αν',
      fitNotFor: [
        'Θέλεις πρώτα το site και τις διαφημίσεις κάποια άλλη στιγμή. Ο στόχος στηρίζεται και στα δύο.',
        'Θέλεις επισκεψιμότητα από την οργανική αναζήτηση αντί για διαφημίσεις. Αυτό είναι άλλο έργο.',
        'Κανείς εσωτερικά δεν μπορεί να διαθέσει τέσσερις με έξι ώρες για το workshop.',
      ...
      faqs: [
        {
          q: 'Πόσο κοστίζει;',
          a: 'Σου δίνουμε προσφορά μετά την πρώτη κλήση, γραπτά, με βάση αυτό που χρειάζεται το site σου και η αγορά σου. Δεν υπάρχει τιμοκατάλογος, γιατί το να κοστολογήσεις ένα site χωρίς να το δεις είναι μαντεψιά. Η αμοιβή κλειδώνει πριν χτιστεί οτιδήποτε. Ο προϋπολογισμός των κλικ είναι ξεχωριστός και τον πληρώνεις εσύ απευθείας στη Google.'
        },
        {
          q: 'Μπορείτε να μας βγάλετε πρώτους στη Google;',
          a: 'Όχι, και κανείς άλλος δεν μπορεί. Η Google δεν πουλάει θέσεις στα οργανικά της αποτελέσματα. Όποιο γραφείο το υπόσχεται πληρώνει το κλικ και το ονομάζει κατάταξη. Αυτό που εγγυόμαστε εμείς είναι ένας στόχος σε leads, συμφωνημένος γραπτά, με επιστροφή της αμοιβής αν η καμπάνια τον χάσει.'
        },
        {
          q: 'Ποιος έχει το site και τον λογαριασμό διαφημίσεων;',
          a: 'Εσύ. Ο λογαριασμός Google Ads ανοίγει στο όνομά σου και μένει εκεί. Το site τρέχει στη δική μας φιλοξενία γιατί έτσι βγαίνει πιο γρήγορα στον αέρα. Μπορείς να το μεταφέρεις όποτε θελήσεις, και σου παραδίδουμε αρχεία και προσβάσεις.'
        },
        {
          q: 'Έχουμε ήδη site. Πρέπει να ξαναχτιστεί;',
          a: 'Όχι πάντα. Αν η πλατφόρμα σου μας αφήνει να δουλέψουμε πάνω της, βελτιώνουμε αυτό που έχεις. Στο workshop σου λέμε ποιος δρόμος φτάνει πιο γρήγορα στον στόχο, και μπαίνει στο αντικείμενο πριν δεσμευτείς.'
        },
        {
          q: 'Τι γίνεται μετά την εκκίνηση;',
          a: 'Η καμπάνια συνεχίζει να τρέχει και θέλει χέρι πάνω της. Η συνεχής διαχείριση Google Ads είναι ξεχωριστή, όπως και το πλάνο φροντίδας που κρατά το site ενημερωμένο. Και τα δύο είναι προαιρετικά.'
        }
      ],

      ctaButton: 'Ξεκίνα το site και την καμπάνια μου',
      ctaCallout:
      ...
      formSubhead:
        'Γράψε μας τι πουλάς και σε ποια περιοχή. Θα σου πούμε τι θα χρειαζόταν για να σου φέρνει leads η Google, και ποιον στόχο θα υπογράφαμε.',
      ...
      formSuccess: 'Ευχαριστούμε. Θα επικοινωνήσουμε μαζί σου για το site και την καμπάνια σου.',
