...
const post: BlogPost = {
  ...
  body: [
    ...
    { type: 'paragraph', text: [
      'Οι συγκρίσεις πλατφορμών μετράνε πράγματα που αλλάζουν: πόσα πρότυπα έχει η καθεμιά, πόσο εύκολος είναι ο επεξεργαστής. Όλα αληθινά, όλα παλιώνουν. Οι τέσσερις παρακάτω δεν παλιώνουν, γιατί είναι όροι.',
    ]},
    { type: 'list', items: [
    ...
    { type: 'table', caption: 'Τα τρία μοντέλα, με τους όρους τους και όχι με τα χαρακτηριστικά τους.', head: ['Μοντέλο', 'Ποιος φιλοξενεί', 'Τι κρατάς αν φύγεις', 'Ποιος ενημερώνει'], rows: [
      [['Συνδρομή (SaaS)'], ['Ο πάροχος, πάντα'], ['Αντίγραφα δεδομένων σε αρχεία, χωρίς το ίδιο το σύστημα'], ['Ο πάροχος, χωρίς να σε ρωτήσει']],
    ...
    { type: 'paragraph', text: [
      'Το δεύτερο που λείπει εκπλήσσει σχεδόν όλους. Είναι οι φωτογραφίες: «Your export file doesn\'t actually contain your media library (like photos, videos, audio, etc.). Instead, it contains instructions that tell your new site where to find and copy these files from your original site.» (',
      {text: 'WordPress.com, Export', href: WPCOM_EXPORT},
      '). Το αρχείο κρατάει ',
    ...
    { type: 'paragraph', text: [
      'Οι παραγγελίες βγαίνουν κι αυτές σε CSV: Οι παραγγελίες βγαίνουν κι αυτές σε CSV. Οι μικρές εξαγωγές κατεβαίνουν κατευθείαν, ενώ οι μεγάλες έρχονται με email: «If you select to export more than 51 orders or to export orders by date, then the CSV file is emailed to you and the store owner.» Πιο σημαντικό είναι τι λείπει από το περιεχόμενο: «The transaction history that\'s included in your CSV file contains only captured payments data. Authorization data isn\'t included in your exported transaction history.» (',
    ...
    { type: 'subheading', text: 'Webflow: η μόνη με πραγματική εξαγωγή κώδικα, αλλά με αστερίσκους' },
    { type: 'paragraph', text: [
    ...
    { type: 'paragraph', text: [
      'Υπάρχουν και πράγματα που δεν λείπουν απλώς, αλλά παύουν να λειτουργούν: «Any password protected pages on your site will no longer be protected after code export. Additionally, site search and forms (including file upload and reCAPTCHA) will not work on exported sites in order to comply with GDPR.» Μια σελίδα που θεωρούσες κλειδωμένη δεν είναι πια. Αυτό δεν είναι λεπτομέρεια μετακόμισης. Είναι θέμα ασφάλειας. Και το καλό νέο, από την ίδια σελίδα: «After exporting, you don’t need to provide attribution to Webflow or maintain a Webflow plan for your exported site to work on your own server.» (',
    ...
    { type: 'table', caption: 'Τι φεύγει μαζί σου, τι μένει πίσω, τι σταματά (με βάση τις προτάσεις που παρατίθενται πιο πάνω).', head: ['Πλατφόρμα', 'Τι εξάγεται', 'Τι δεν εξάγεται', 'Αν σταματήσεις να πληρώνεις'], rows: [
      ...
      [['Wix'], ['Συλλογές CMS σε CSV, με όλα τα πεδία'], ['Η ίδια η ιστοσελίδα. Το δηλώνει το Wix: πρέπει να τρέχει στους διακομιστές του'], ['Η διεύθυνση γυρίζει στο δωρεάν Wix URL, με διαφημίσεις Wix']],
