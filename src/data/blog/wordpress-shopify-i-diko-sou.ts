...
const post: BlogPost = {
  ...
  body: [
    ...
    { type: 'table', caption: 'Τι φεύγει μαζί σου, τι μένει πίσω, τι σταματά — με βάση τις προτάσεις που παρατίθενται πιο πάνω.', head: ['Πλατφόρμα', 'Τι εξάγεται', 'Τι δεν εξάγεται', 'Αν σταματήσεις να πληρώνεις'], rows: [
      ...
      [['Webflow'], ['Ο κώδικας του site σε πλάνα Workspace· CMS, ηλεκτρονικό εμπόριο και χρήστες χωριστά σε CSV'], ['Το περιεχόμενο μέσα στον κώδικα: οι λίστες συλλογών βγαίνουν άδειες· προστασία με κωδικό, αναζήτηση και φόρμες παύουν να λειτουργούν'], ['Ό,τι έχεις εξάγει τρέχει στον δικό σου διακομιστή χωρίς ενεργό πλάνο']],
    ]},
    ...
    { type: 'paragraph', text: [
      'Επειδή γράφουμε λογισμικό, θα ήταν βολικό να καταλήγει το κείμενο στο «φτιάξε κάτι δικό σου». Δεν καταλήγει, γιατί το δικό σου δεν λύνει τα προβλήματα της λίστας — τα μετακινεί σε εσένα. Δικός σου server σημαίνει δικές σου ενημερώσεις, δικά σου αντίγραφα, δική σου παρακολούθηση.',
    ]},
    { type: 'list', items: [
