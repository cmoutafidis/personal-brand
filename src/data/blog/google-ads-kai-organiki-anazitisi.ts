...
const post: BlogPost = {
  ...
  body: [
    { type: 'paragraph', text: [
      ...
      ' — ότι πληρώνεις για να φτάσεις πιο γρήγορα εκεί όπου θα έφτανες έτσι κι αλλιώς. Δεν λειτουργεί έτσι. Είναι δύο χωριστά συστήματα που απαντούν σε δύο διαφορετικά ερωτήματα.',
    ]},
    { type: 'paragraph', text: [
    ...
    { type: 'table', caption: 'Το ίδιο ερώτημα του χρήστη, δύο εντελώς διαφορετικοί μηχανισμοί.', head: ['Τι εξετάζεις', 'Διαφήμιση (Google Ads)', 'Οργανικό αποτέλεσμα'], rows: [
      [['Πώς μπαίνεις'], ['Λογαριασμός, λέξεις-κλειδιά, προσφορά — και μπαίνεις σε δημοπρασία'], ['Η Google περιλαμβάνει αυτόματα τους περισσότερους ιστότοπους, χωρίς να το εγγυάται']],
    ...
    { type: 'paragraph', text: [
      ...
      ' Χτίζεται από τα δεδομένα του προϊόντος — φωτογραφία, τίτλος, η τιμή του προϊόντος, το κατάστημα — όχι από φράσεις που δηλώνεις.',
    ]},
    { type: 'paragraph', text: [
