...
const GR_REGUL = 'https://grweb.ics.forth.gr/public/domains/regulation';
...
const post: BlogPost = {
  ...
  body: [
    ...
    {type: 'note', text: [
      {text: 'Έλεγχος στοιχείων: 2 και 6 Σεπτεμβρίου 2026.', strong: true},
      ' Κάθε πρόταση που παρατίθεται εδώ ελέγχθηκε στις 2 Σεπτεμβρίου 2026 στη σελίδα που τη συνοδεύει, και τα στοιχεία για τα ονόματα χώρου ελέγχθηκαν ξανά στις 6 Σεπτεμβρίου 2026. Το κείμενο δεν αναφέρει κανένα ποσό: δεν υπάρχει τιμή που να ισχύει για δύο διαφορετικά έργα, και μια τιμή χωρίς τη λίστα από κάτω της δεν λέει τίποτα.',
    ]},
    ...
    {type: 'paragraph', text: [
      ...
      '), και οι Συχνές Ερωτήσεις το επιβεβαιώνουν: «Το κόστος για την εκχώρηση ενός ονόματος χώρου διαφέρει από καταχωρητή σε καταχωρητή.» Η ίδια απάντηση συνεχίζει: «Το ανώτατο ποσό χρέωσης καθορίζεται στον Κανονισμό Διαχείρισης και Εκχώρησης Ονομάτων Χώρου με κατάληξη .gr ή .ελ.» Υπάρχει δηλαδή οροφή στον κανονισμό, και κάτω από αυτήν ο κάθε καταχωρητής βάζει τη δική του τιμή. Οι ίδιες Συχνές Ερωτήσεις προσθέτουν ότι «Ο καταχωρητής δύναται να απαιτεί την πληρωμή τελών από τους καταχωρούμενους και σε περίπτωση που δεν απαιτείται καταβολή τελών στην ΕΕΤΤ.»',
    ]},
    {type: 'paragraph', text: [
      'Και γιατί το «σε ποιο όνομα» είναι γραμμή προσφοράς: αν χαθεί μια ανανέωση, «Με την παρέλευση της περιόδου των δεκαπέντε (15) ημερών από τη λήξη του ονόματος, το όνομα διατίθεται προς εκχώρηση σε οποιοδήποτε ενδιαφερόμενο πρόσωπο.» Δεκαπέντε ημέρες, και μετά η διεύθυνσή σου είναι διαθέσιμη σε οποιονδήποτε.',
    ]},
    {type: 'paragraph', text: [
      'Ποιο κείμενο τα ορίζει; Η σελίδα καταχώρησης του Μητρώου παραπέμπει σε απόφαση της ΕΕΤΤ: «Σύμφωνα με την απόφαση 1110/6/29-04-2024 της ΕΕΤΤ, ο χρήστης που επιθυμεί την καταχώρηση ενός ονόματος πρέπει να καταθέσει μια δήλωση σε έναν από τους καταχωρητές ονομάτων χώρου με κατάληξη .gr ή .ελ.» (',
      {text: 'Μητρώο .gr και .ελ, Διαδικασία καταχώρησης', href: GR_REG},
      '). Η απόφαση εκείνη τροποποιήθηκε με την ΑΠ 1178/5/15.12.2025 της ΕΕΤΤ (ΦΕΚ Β΄ 6931/22.12.2025) και εξακολουθεί να ισχύει με τις αλλαγές αυτές· το Μητρώο δημοσιεύει και τα δύο κείμενα (',
      {text: 'Μητρώο .gr και .ελ, Κανονιστικά κείμενα', href: GR_REGUL},
      '). Η τροποποίηση του 2025 δεν άλλαξε ούτε τη διετία, ούτε τη χρέωση της ανανέωσης, ούτε τις δεκαπέντε ημέρες.',
    ]},
    ...
    {type: 'sources', heading: 'Πηγές', items: [
      ...
      {label: 'Μητρώο Ονομάτων Internet .gr και .ελ, Κανονιστικά Κείμενα (ο κωδικοποιημένος κανονισμός και η ΑΠ 1178/5/15.12.2025) (ανακτήθηκε 6 Σεπτεμβρίου 2026)', url: GR_REGUL},
