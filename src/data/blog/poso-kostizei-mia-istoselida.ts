...
const post: BlogPost = {
  ...
  body: [
    ...
    {type: 'paragraph', text: [
      ...
      ') — διαφορετικό καθεστώς, διαφορετική γραμμή, και σε καμία περίπτωση σύγκριση με σχεδιασμό που γίνεται για εσένα.',
    ]},
    ...
    {type: 'paragraph', text: [
      'Το τρίτο αναφέρεται ρητά ως «Monthly or yearly subscription fees.» — έξοδο που δεν σταματά. Και για τις premium πύλες: «These require an annual subscription to WooCommerce.com for support and updates, along with the processor’s standard transaction fees.» Δύο επαναλαμβανόμενες γραμμές, όχι μία.',
    ]},
    {type: 'paragraph', text: [
