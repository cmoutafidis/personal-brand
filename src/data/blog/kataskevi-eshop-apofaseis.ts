...
const post: BlogPost = {
  ...
  body: [
    ...
    { type: 'paragraph', text: [
      ...
      ". «The transaction history that's included in your CSV file contains only captured payments data. Authorization data isn't included in your exported transaction history.» Και στον οδηγό μετάβασης από το WooCommerce το ίδιο το Shopify γράφει: «You can't export or migrate reviews from WooCommerce to Shopify.» — ",
    ...
    { type: 'table', caption: 'Τι δηλώνει η τεκμηρίωση κάθε πλατφόρμας ότι βγαίνει — και τι όχι. Έλεγχος: 2 Σεπτεμβρίου 2026.', head: ['Πλατφόρμα', 'Τι δηλώνει ότι βγαίνει', 'Τι δεν βγαίνει, ή θέλει κάτι παραπάνω'], rows: [
      ...
      [['WooCommerce'], ['Προϊόντα, με εργαλείο CSV φτιαγμένο και για μεταφορά μεταξύ καταστημάτων'], ['Πελάτες, παραγγελίες, κουπόνια — μέσω εμπορικής επέκτασης, όχι από τον πυρήνα']],
    ...
    { type: 'paragraph', text: [
      ...
      ' — τι χρειάζεται για να ανοίξει ο λογαριασμός στον πάροχο, όχι φορολογικό θέμα.',
    ]},
    { type: 'paragraph', text: [
    ...
    { type: 'paragraph', text: [
      'Οι περισσότεροι σχεδιάζουν την πολιτική επιστροφών σαν εμπορική απόφαση. Μεγάλο μέρος της δεν είναι: είναι κανόνας που ισχύει ούτως ή άλλως και το λογισμικό πρέπει να τον υποστηρίζει. Αν το ανακαλύψεις μετά, το κόστος δεν είναι η πολιτική — είναι η αλλαγή στο σύστημα.',
    ]},
    { type: 'paragraph', text: [
    ...
    { type: 'paragraph', text: [
      ...
      '. Αν το πρότυπο που σου δίνουν βάζει ακόμα τον παλιό σύνδεσμο ΗΕΔ στο υποσέλιδο, δεν οδηγεί πουθενά — φθηνό τεστ για το πόσο πρόσφατα ενημερώθηκε ό,τι σου πουλάνε.',
    ]},
    { type: 'paragraph', text: [
    ...
    { type: 'paragraph', text: [
      ...
      ' — που αλλάζει τι φορτώνει η σελίδα πριν τη συγκατάθεση. Πολύ φθηνότερο να γίνει στην κατασκευή παρά να ξηλωθεί μετά.',
    ]},
    ...
    { type: 'paragraph', text: [
      'Όλα τα παραπάνω γίνονται ένας έλεγχος, με ένα δοκιμαστικό κατάστημα και ένα λογιστικό φύλλο. Δεν χρειάζεσαι τεχνικές γνώσεις — χρειάζεσαι να ανοίξεις τα αρχεία και να δεις τι λείπει.',
    ]},
