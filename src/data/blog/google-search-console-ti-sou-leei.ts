...
const post: BlogPost = {
  ...
  body: [
    ...
    {type: 'faq', heading: 'Σύντομες απαντήσεις', items: [
      ...
      {q: 'Το «Ανακαλύφθηκε — δεν έχει ευρετηριαστεί» είναι σφάλμα;', a: 'Όχι απαραίτητα. Η Google γράφει ότι οι σελίδες που δεν ευρετηριάστηκαν δεν είναι απαραίτητα σφάλμα και ότι πρέπει να διαβάσεις τη συγκεκριμένη περιγραφή. Για τη συγκεκριμένη κατάσταση λέει ότι βρήκε τη σελίδα, ήθελε να να την ανιχνεύσει, υπολόγισε ότι θα υπερφόρτωνε το site και ανέβαλε τη ανίχνευση.'},
    ...
    {type: 'table', caption: 'Τι σημαίνουν οι καταστάσεις που παρεξηγούνται πιο συχνά.', head: ['Κατάσταση', 'Τι λέει η τεκμηρίωση', 'Τι κάνεις'], rows: [
      [['Ανακαλύφθηκε — δεν έχει ευρετηριαστεί'], ['Βρέθηκε, δεν ανιχνεύθηκε ακόμα· η ανίχνευση αναβλήθηκε γιατί υπολογίστηκε ότι θα υπερφόρτωνε το site'], ['Κοιτάς τον διακομιστή και τον χρόνο απόκρισης, όχι το κείμενο']],
