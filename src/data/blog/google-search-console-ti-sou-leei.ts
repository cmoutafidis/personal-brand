...
const post: BlogPost = {
  ...
  body: [
    ...
    {type: 'faq', heading: 'Σύντομες απαντήσεις', items: [
      ...
      {q: 'Το «Ανακαλύφθηκε — δεν έχει ευρετηριαστεί» είναι σφάλμα;', a: 'Όχι απαραίτητα. Η Google γράφει ότι οι σελίδες που δεν ευρετηριάστηκαν δεν είναι απαραίτητα σφάλμα και ότι πρέπει να διαβάσεις τη συγκεκριμένη περιγραφή. Για τη συγκεκριμένη κατάσταση λέει ότι βρήκε τη σελίδα, ήθελε να την ανιχνεύσει, υπολόγισε ότι θα υπερφόρτωνε τον ιστότοπο και ανέβαλε την ανίχνευση.'},
    ...
    {type: 'heading', text: 'Τι είναι και τι δεν είναι, με μια πρόταση'},
    {type: 'paragraph', text: [
    ...
    {type: 'paragraph', text: [
      ...
      ' Δίνει τέσσερα μεγέθη: κλικ, εμφανίσεις, ποσοστό κλικ (CTR) και μέση θέση. Τα τρία από τα τέσσερα διαβάζονται συστηματικά λάθος.',
    ]},
    ...
    {type: 'paragraph', text: [
      ...
      ' Δηλαδή μετράει τη θέση του κορυφαίου αποτελέσματος ολόκληρης της ιστοσελίδας. Στον πίνακα, ο αριθμός αφορά τη συγκεκριμένη γραμμή, τη συγκεκριμένη σελίδα ή το συγκεκριμένο ερώτημα.',
    ]},
    {type: 'paragraph', text: [
