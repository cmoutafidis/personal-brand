...
const G_CORE_UPDATES = 'https://developers.google.com/search/docs/appearance/core-updates';
...
const post: BlogPost = {
  ...
  body: [
    ...
    {type: 'faq', heading: 'Σύντομες απαντήσεις', items: [
      ...
      {q: 'Μπορεί κάποιος να μου εγγυηθεί την πρώτη θέση;', a: 'Όχι, και δεν είναι θέμα ήθους αλλά αρχιτεκτονικής: η κατάταξη γίνεται από λογισμικό, πάνω σε πράγματα που δεν σου ανήκουν, όπως τον ανταγωνισμό, τον χρήστη, τη διαρκή αλλαγή των συστημάτων. Το γράφει η ίδια η Google στη σελίδα της για την πρόσληψη ειδικού SEO.'},
    ...
    {type: 'table', caption: 'Το πεδίο της αναζήτησης, χωρισμένο σε τρεις στήλες.', head: ['Κομμάτι', 'Σε ποια στήλη ανήκει', 'Τι λέει η τεκμηρίωση'], rows: [
      [['Οι λέξεις που υπάρχουν πάνω στη σελίδα σου'], [{text: 'Ελέγχεις', strong: true}], ['Η Google λέει «complete control» μόνο για τις λέξεις της σελίδας· το απόσπασμα που εμφανίζεται το συνθέτει η ίδια']],
    ...
    {type: 'paragraph', text: [
      'Μένει το πιο ορατό κομμάτι, αυτό που βλέπει ο άλλος στα αποτελέσματα. Ούτε αυτό είναι δικό σου. Για τον τίτλο: «Google’s generation of title links on the Google Search results page is completely automated and takes into account both the content of a page and references to it that appear on the web.» (',
    ...
    {type: 'table', caption: 'Τρία πράγματα που η αγορά τα λέει όλα «ποινή».', head: ['Τι συνέβη', 'Ποιος το προκάλεσε', 'Πώς το ξεχωρίζεις'], rows: [
      ...
      [['Αλλαγή ζήτησης'], ['Οι ίδιοι οι χρήστες, από τάση ή εποχικότητα'], ['Η θέση μένει ίδια και μειώνεται το πλήθος των αναζητήσεων, όχι το μερίδιό σου']],
    ]},
    {type: 'paragraph', text: [
