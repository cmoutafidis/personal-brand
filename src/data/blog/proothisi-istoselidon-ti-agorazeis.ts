...
const post: BlogPost = {
  ...
  body: [
    { type: 'paragraph', text: [
      ...
      ' που πωλούνται με το ίδιο όνομα, και η κάθε μία σού αφήνει κάτι εντελώς διαφορετικό στα χέρια όταν τελειώσει η συνεργασία. Ένα μέρος σταματά την ίδια μέρα που σταματάς να πληρώνεις. Το άλλο μένει. Αρκεί να είναι γραμμένο στο σωστό όνομα.',
    ]},
    { type: 'paragraph', text: [
    ...
    { type: 'faq', heading: 'Σύντομες απαντήσεις', items: [
      ...
      {q: 'Αρκεί να διαγράψω τον πάροχο όταν φύγει;', a: 'Στο Search Console όχι. Η Google γράφει ότι όταν αφαιρείς έναν ιδιοκτήτη το token επαλήθευσής του δεν ακυρώνεται, οπότε μπορεί να ξανα-επαληθευτεί μόνος του. Πρέπει να φύγει και το token από την ιστοσελίδα, και αυτό θέλει προσοχή: μπορεί να το χρησιμοποιούν και άλλες υπηρεσίες.'},
    ...
    { type: 'paragraph', text: [
      'Γιατί έχει σημασία: ρόλους αναθέτει μόνο ο Administrator σε επίπεδο λογαριασμού. Και ο ρόλος που ακούγεται δυνατός δεν είναι δυνατός. Ο Editor έχει πλήρη έλεγχο των ρυθμίσεων της ιδιότητας αλλά δεν διαχειρίζεται χρήστες (',
    ...
    { type: 'paragraph', text: [
      'Το τέταρτο πράγμα που πωλείται ως προώθηση είναι οι καταχωρήσεις, το κλασικό «θα σε βάλουμε σε πεντακόσιους καταλόγους». Εδώ δεν χρειάζεται γνώμη: η Google απαριθμεί ονομαστικά τι θεωρεί ανεπιθύμητη πρακτική συνδέσμων, και μέσα στη λίστα υπάρχει η φράση «Low-quality directory or bookmark site links» (',
