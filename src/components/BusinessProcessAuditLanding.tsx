...
const copy: Record<Language, LandingCopy> = {
  en: {
    ...
    heroSubhead: 'We find the manual processes quietly draining your business, then build the custom software and automation that make them disappear. It starts with a free Process Audit that shows you exactly where the money is leaking. It ends with a written guarantee.',
    heroBullets: [
      {
      ...
      },
      {
        ...
        body: 'Custom software and automation, including AI where it genuinely helps. Built from scratch for your business.'
      },
      {
    ...
    storyParagraphs: [
      ...
      'These teams work hard. The problem is that nobody ever sat down, mapped the process end to end, and built the boring, reliable software that makes it disappear.',
      'That is the entire job of Fiji Solutions. We map how your business actually works, find where it bleeds time and money, and build the exact fix. Then we maintain it so it keeps working. Every fix is built by us, specifically for you.',
    ...
    painParagraphs: [
      'It’s 9pm on a Tuesday and you’re still at your desk, copying numbers from one system into another. If you don’t do it, nobody will. And if it’s wrong, a client will find it before you do.',
      ...
      'You’re now your business’s most overqualified data-entry clerk. Every year the admin grows faster than the revenue. The week you’d spend fixing it never comes, because you’re too busy surviving it.'
    ],
    leaksTitle: 'The five leaks we see in almost every small business',
    leaks: [
      {
        lead: 'Double entry.',
        body: 'The same data typed into two, three, sometimes four systems. Every retype is a chance for the error a client finds first.'
      },
      {
      ...
      },
      {
        ...
        body: 'Problems that surface only after they’ve cost you something. Your best people spend the week reacting instead of improving anything.'
      },
      {
        lead: 'The 60% tool.',
    ...
    trustCards: [
      ...
      },
      {
        ...
        body: 'Fiji Solutions IKE, registered in Greece (GEMI 185101306000), Porto Center, Thessaloniki. An office you can walk into.'
      },
      {
    ...
    dreamBullets: [
      ...
      },
      {
        ...
        body: 'Quotes, invoices, and reminders go out on time, every time. Nobody has to remember to do it.'
      },
      {
        before: 'Firefighting',
      ...
      },
      {
        ...
        body: 'Built entirely around your process.'
      },
      {
    ...
    stackItems: [
      {
        lead: 'The audit call.',
        body: '45–60 minutes with the person who would actually build your fix.'
      },
      {
        lead: 'Your Process Money-Leak Map.',
        body: 'A written, prioritised list of your three costliest bottlenecks. It’s the kind of document consultancies charge real money for. Yours to keep.'
      },
      {
    ...
    bonusItems: [
      ...
      },
      {
        ...
        body: 'After go-live we watch the numbers and tighten whatever the real world reveals. This is included.'
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Only where AI genuinely helps. Many of the highest-ROI fixes are plain integrations and automations. We add whatever makes the problem disappear.'
      },
      {
    ...
    guaranteeClosing: 'The full terms, including exactly how we measure, go into the contract before we build. You can hold us to every word.',
    scarcityTitle: 'Why we only run two builds at a time',
    scarcityBody: 'Everything we ship is designed and built by us, in-house. That has one honest consequence: we run at most two builds at a time. When both slots are taken, the next audit goes on a dated waitlist and we tell you so. We’d rather you wait two weeks than get a rushed build.',
    psParagraphs: [
  ...
  el: {
    ...
    heroSubhead: 'Βρίσκουμε τις χειροκίνητες διαδικασίες που αθόρυβα στραγγίζουν την επιχείρησή σου και χτίζουμε το custom λογισμικό και τους αυτοματισμούς που τις εξαφανίζουν. Ξεκινά με ένα δωρεάν Process Audit που σου δείχνει ακριβώς πού διαρρέουν τα χρήματα. Κλείνει με γραπτή εγγύηση.',
    heroBullets: [
      {
      ...
      },
      {
        ...
        body: 'Custom λογισμικό και αυτοματισμοί, με AI εκεί που πραγματικά βοηθά. Χτισμένα από το μηδέν για την επιχείρησή σου.'
      },
      {
    ...
    cta: {
      ...
      callout: 'Το audit είναι δωρεάν, χωρίς καμία δέσμευση. Κάθε λύση που χτίζουμε καλύπτεται από την Εγγύηση Απόσβεσης. Αν η λύση που χτίζουμε δεν αποσβέσει το κόστος της μέσα σε 6 μήνες από το go-live, σου επιστρέφουμε την αμοιβή υλοποίησης.',
    ...
    painParagraphs: [
      'Είναι 9 το βράδυ Τρίτης και είσαι ακόμα στο γραφείο, αντιγράφοντας νούμερα από το ένα σύστημα στο άλλο. Αν δεν το κάνεις εσύ, δεν θα το κάνει κανείς. Κι αν γίνει λάθος, θα το βρει πρώτος ένας πελάτης.',
      ...
      'Έχεις καταλήξει ο πιο υπερειδικευμένος υπάλληλος καταχώρησης δεδομένων της ίδιας σου της επιχείρησης. Κάθε χρόνο η γραφειοκρατία μεγαλώνει πιο γρήγορα από τον τζίρο. Η εβδομάδα που θα αφιέρωνες για να το φτιάξεις δεν έρχεται ποτέ, γιατί είσαι πολύ απασχολημένος να τα βγάλεις πέρα μαζί της.'
    ],
    leaksTitle: 'Οι πέντε διαρροές που βλέπουμε σχεδόν σε κάθε μικρή επιχείρηση',
    leaks: [
      {
        lead: 'Διπλή καταχώρηση.',
        body: 'Τα ίδια δεδομένα πληκτρολογούνται σε δύο, τρία, καμιά φορά τέσσερα συστήματα. Κάθε επανάληψη είναι μια ευκαιρία για το λάθος που θα βρει πρώτος ένας πελάτης.'
      },
      {
      ...
      },
      {
        ...
        body: 'Προβλήματα που εμφανίζονται μόνο αφού σου έχουν ήδη κοστίσει. Έτσι οι καλύτεροί σου άνθρωποι περνούν την εβδομάδα αντιδρώντας αντί να βελτιώνουν οτιδήποτε.'
      },
      {
    ...
    cta2Lead: 'Μάθε τι πραγματικά σου κοστίζουν οι διαδικασίες σου. Είναι δωρεάν, και το έχεις γραπτά μέσα σε μία εβδομάδα από την κλήση του audit.',
    ...
    trustCards: [
      ...
      },
      {
        ...
        body: 'Fiji Solutions ΙΚΕ, καταχωρημένη στην Ελλάδα (ΓΕΜΗ 185101306000), Porto Center, Θεσσαλονίκη. Ένα γραφείο που μπορείς να επισκεφτείς.'
      },
      {
    ...
    offerIntro: 'Μια done-for-you συνεργασία σε τρία βήματα. Ο στόχος συμφωνείται γραπτά πριν χτιστεί οτιδήποτε.',
    offerSteps: [
      {
        step: 'Βήμα 1',
      ...
      },
      {
        ...
        body: 'Αν ο χάρτης δείξει μια λύση που αξίζει να χτιστεί, τρέχουμε ένα εστιασμένο sprint με την ομάδα σου: αποτυπώνουμε τα workflows βήμα βήμα, κατατάσσουμε κάθε πιθανή λύση με βάση την απόδοση της επένδυσης και συμφωνούμε γραπτά τον στόχο απόσβεσης. Εγκρίνεις το πλάνο, την τιμή και τον στόχο πριν γραφτεί έστω μία γραμμή κώδικα.'
      },
      {
        step: 'Βήμα 3',
    ...
    dreamBullets: [
      ...
      },
      {
        ...
        body: 'Προσφορές, τιμολόγια και υπενθυμίσεις φεύγουν στην ώρα τους, κάθε φορά. Κανείς δεν χρειάζεται να το θυμάται.'
      },
      {
      ...
      },
      {
        ...
        body: 'Χτισμένο εξ ολοκλήρου γύρω από τη δική σου διαδικασία.'
      },
      {
    ...
    dreamGoal: 'Στόχος μας σε κάθε συνεργασία είναι να δώσουμε πίσω στην ομάδα σου 5–10 ώρες την εβδομάδα. Στο δωρεάν audit υπολογίζουμε ακριβώς πόσες ώρες σου κοστίζουν οι διαδικασίες σου. Αυτό το νούμερο γίνεται ο γραπτός στόχος για τον οποίο λογοδοτούμε.',
    ...
    stackItems: [
      {
        ...
        body: '45–60 λεπτά με τον άνθρωπο που θα έχτιζε πραγματικά τη λύση σου.'
      },
      {
        lead: 'Τον Χάρτη Διαρροών σου.',
        body: 'Μια γραπτή, ιεραρχημένη λίστα με τα τρία πιο ακριβά bottlenecks σου. Είναι το είδος του εγγράφου για το οποίο οι σύμβουλοι χρεώνουν κανονικά χρήματα. Δικός σου.'
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Μια εφάπαξ αμοιβή υλοποίησης και ένα μικρό μηνιαίο πλάνο φροντίδας. Τα ακριβή νούμερα έρχονται μετά το audit, γιατί εξαρτώνται αποκλειστικά από το τι θα βρούμε. Αυτό που είναι δεσμευτικό από πριν είναι η εγγύηση. Αν η λύση που χτίζουμε δεν αποσβέσει το κόστος της μέσα σε 6 μήνες από το go-live, σου επιστρέφουμε την αμοιβή υλοποίησης.'
      },
      {
      ...
      },
      {
        ...
        a: 'Αυτό ακριβώς είναι το νόημα. Το audit θέλει περίπου μία ώρα από τον χρόνο σου· κατά την υλοποίηση, τη δουλειά την κάνουμε εμείς και η ομάδα σου συνεχίζει κανονικά. Αυτό είναι done-for-you από την αρχή ως το τέλος.'
      },
      {
      ...
      },
      {
        ...
        a: 'Μόνο εκεί που το AI βοηθά πραγματικά. Πολλές από τις λύσεις με το μεγαλύτερο ROI είναι απλές διασυνδέσεις και αυτοματισμοί. Προσθέτουμε ό,τι εξαφανίζει το πρόβλημα.'
      },
      {
    ...
    bioClosing: [
      'Όταν κλείνεις ένα audit, μιλάς με εμένα. Είμαι ο ίδιος άνθρωπος που σχεδιάζει τη δουλειά, χτίζει το λογισμικό και στέκεται πίσω από την εγγύηση. Χωρίς account managers, χωρίς ενδιάμεσους, χωρίς «χαλασμένο τηλέφωνο» ανάμεσα σε πωλήσεις και υλοποίηση.',
