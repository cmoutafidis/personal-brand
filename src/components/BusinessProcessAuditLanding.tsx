...
const copy: Record<Language, LandingCopy> = {
  en: {
    ...
    guaranteePoints: [
      ...
      {
        lead: 'What voids it.',
        body: 'Two things only: changing the process the software was built for without telling us, and refusing the access needed to measure. Nothing else. We will not argue about anything we did not write down before we built.'
      }
    ],
  ...
  el: {
    ...
    heroSubhead: 'Βρίσκουμε τις χειροκίνητες διαδικασίες που αθόρυβα στραγγίζουν την επιχείρησή σου και χτίζουμε το εξατομικευμένο λογισμικό και τους αυτοματισμούς που τις εξαφανίζουν. Ξεκινά με έναν δωρεάν έλεγχο διαδικασιών που σου δείχνει ακριβώς πού διαρρέουν τα χρήματα. Κλείνει με γραπτή εγγύηση.',
    heroBullets: [
      {
      ...
      },
      {
        ...
        body: 'Εξατομικευμένο λογισμικό και αυτοματισμοί, με AI εκεί που πραγματικά βοηθά. Χτισμένα από το μηδέν για την επιχείρησή σου.'
      },
      {
    ...
    leaks: [
      ...
      {
        lead: 'Καθυστερημένες υπενθυμίσεις.',
    ...
    dreamBullets: [
      ...
      {
        before: 'Καθυστερημένες υπενθυμίσεις',
      ...
      },
      {
        ...
        body: 'Πίνακες και ειδοποιήσεις αναδεικνύουν ό,τι πάει στραβά όσο ακόμα διορθώνεται φθηνά. Δευτέρες χωρίς εκπλήξεις.'
      },
      {
    ...
    bonusItems: [
      ...
      {
        lead: 'Περίοδος βελτιστοποίησης 30 ημερών μετά τη θέση σε λειτουργία.',
        body: 'Μετά τη θέση σε λειτουργία παρακολουθούμε τα νούμερα και ρυθμίζουμε ό,τι αναδείξει η πραγματική χρήση, χωρίς επιπλέον κόστος.'
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Κατά τον έλεγχο καταγράφουμε τη βάση αναφοράς σου: ώρες που ξοδεύονται, ποσοστά λαθών, καθυστερήσεις. Πριν χτίσουμε, συμφωνούμε γραπτά τι πρέπει να εξοικονομεί η λύση. Μετά συγκρίνουμε με αυτή τη βάση σε συμφωνημένα σημεία ελέγχου. Χωρίς αόριστες υποσχέσεις, χωρίς στόχους που μετακινούνται στην πορεία.'
      },
      {
      ...
      },
      {
        ...
        a: 'Μόνο εκεί που το AI βοηθά πραγματικά. Πολλές από τις λύσεις με τη μεγαλύτερη απόδοση είναι απλές διασυνδέσεις και αυτοματισμοί. Προσθέτουμε ό,τι εξαφανίζει το πρόβλημα.'
      },
      {
        q: 'Μήπως είμαστε πολύ μικροί για κάτι τέτοιο;',
        a: 'Αν δύο ή περισσότεροι άνθρωποι ξοδεύουν ώρες κάθε εβδομάδα σε επαναλαμβανόμενη χειροκίνητη δουλειά, είστε αρκετά μεγάλοι για να βγαίνουν τα νούμερα. Ο έλεγχος θα σου το δείξει έτσι κι αλλιώς, δωρεάν.'
      }
    ],
    ...
    guaranteePoints: [
      {
        ...
        body: 'Κατά τον δωρεάν έλεγχο μετράμε τη βάση αναφοράς σου: ώρες που ξοδεύονται, λάθη, καθυστερήσεις. Ο στόχος απόσβεσης βγαίνει από αυτά τα νούμερα και μπαίνει στο συμβόλαιο, γραπτά.'
      },
      {
      ...
      },
      {
        ...
        body: 'Μόνο δύο πράγματα: να αλλάξεις τη διαδικασία για την οποία χτίστηκε το λογισμικό χωρίς να μας το πεις, και να μην μας δώσεις την πρόσβαση που χρειάζεται για τη μέτρηση. Τίποτα άλλο. Δεν πρόκειται να διαφωνήσουμε για κάτι που δεν γράψαμε πριν χτίσουμε.'
      }
    ],
...
export default function BusinessProcessAuditLanding({language}: BusinessProcessAuditLandingProps) {
  ...
  return (
    <>
      ...
      {/* 14. PS-style close.
          The capacity section that opened this block was deleted on 2026-08-15: "we run at most
          two builds at a time" and "a dated waitlist" were published commitments with nothing
          behind them anywhere in the repo. Put it back only with a real, countable number. */}
      <section className="bg-white py-16 dark:bg-gray-900 md:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
