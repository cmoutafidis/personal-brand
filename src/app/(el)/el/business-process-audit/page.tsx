...
export const metadata: Metadata = {
  ...
  description: `Κλείσε δωρεάν έλεγχο διαδικασιών: γραπτό πλάνο με τα τρία σημεία που σου κοστίζουν χρήματα, και μετά εξατομικευμένο λογισμικό με Εγγύηση Απόσβεσης. Απόσβεση σε ${GUARANTEE_WINDOW_MONTHS} μήνες από τη θέση σε λειτουργία, αλλιώς επιστρέφουμε την αμοιβή υλοποίησης.`,
