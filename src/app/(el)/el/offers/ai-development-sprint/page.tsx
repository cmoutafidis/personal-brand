...
export const metadata: Metadata = buildOfferMetadata(aiDevelopmentSprint, 'el');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(aiDevelopmentSprint, 'el'))}}
      />
      <OfferLanding offer={aiDevelopmentSprint} language="el"/>
