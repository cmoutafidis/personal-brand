...
export const metadata: Metadata = buildOfferMetadata(aiAgent, 'el');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(aiAgent, 'el'))}}
      />
      <OfferLanding offer={aiAgent} language="el"/>
