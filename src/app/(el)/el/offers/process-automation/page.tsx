...
export const metadata: Metadata = buildOfferMetadata(processAutomation, 'el');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(processAutomation, 'el'))}}
      />
      <OfferLanding offer={processAutomation} language="el"/>
