...
export const metadata: Metadata = buildOfferMetadata(websiteSeo, 'el');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(websiteSeo, 'el'))}}
      />
      <OfferLanding offer={websiteSeo} language="el"/>
