    ...
    <div className="min-h-screen bg-white pt-20 dark:bg-gray-900">
      ...
      <section className="bg-gray-50 py-16 dark:bg-gray-800 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Need software connected to data?</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
            We also help with data analysis, BI dashboards, and Snowflake AI Data Cloud projects, so your software and reporting work together.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Link href="/en/services/snowflake-consulting-greece" className="rounded-lg border border-gray-300 px-6 py-3 font-semibold text-gray-900 transition hover:bg-white dark:border-gray-600 dark:text-white dark:hover:bg-gray-900">Snowflake Consulting</Link>
          </div>
        </div>
      </section>
      <Footer t={t} />
