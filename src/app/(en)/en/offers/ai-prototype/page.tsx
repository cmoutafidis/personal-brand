...
export const metadata: Metadata = buildOfferMetadata(aiPrototype, 'en');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(aiPrototype, 'en'))}}
      />
      <OfferLanding offer={aiPrototype} language="en"/>
