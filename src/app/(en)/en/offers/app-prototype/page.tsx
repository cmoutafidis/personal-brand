...
export const metadata: Metadata = buildOfferMetadata(appPrototype, 'en');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(appPrototype, 'en'))}}
      />
      <OfferLanding offer={appPrototype} language="en"/>
