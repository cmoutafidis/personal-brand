...
// Everything on it comes from src/data/offers/process-automation.ts and src/components/OfferLanding.tsx.

export const metadata: Metadata = buildOfferMetadata(processAutomation, 'en');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(processAutomation, 'en'))}}
      />
      <OfferLanding offer={processAutomation} language="en"/>
