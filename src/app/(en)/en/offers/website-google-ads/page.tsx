...
export const metadata: Metadata = buildOfferMetadata(websiteGoogleAds, 'en');
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{__html: JSON.stringify(offerSchema(websiteGoogleAds, 'en'))}}
      />
      <OfferLanding offer={websiteGoogleAds} language="en"/>
